...
6. Select a batch:
   ...
   - **ARCHIVE**: Choose a thematic group from older pending videos. Scan titles for game names, series, or topics. Pick a theme that makes a compelling Keeper post. Aim for 5-10 videos. If a theme has more, save the rest for the next run.
...
12. Update CHANGELOG.md with run summary.
13. Commit and push:
    ```
    git add video_index.json docs/index.html archive/ keeper-posts/ CHANGELOG.md
