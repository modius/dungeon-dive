...
- [ ] **Build `check_integrity.py`** — verify index, YouTube, Discourse, and local archive all agree on counts and status. Read-only, report-only.
...
- [ ] **Keeper post format** — define the format and target topic for automated Keeper posts
